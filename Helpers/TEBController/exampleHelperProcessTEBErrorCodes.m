...
% 
%                     % Generate optimal path for velcmds
%                     dt = min([1e-2; diff(tstamps)]);
%                     curpath = exampleHelperIntegrateControlSequence(curpose,velcmds,tstamps,dt);
% 
...
%                     stateFree = exampleHelperCheckVehicleCollision(sdf,curpath,collisionChecker);
% 
%                     if ~all(stateFree)
...
%                             end
%                         else
%                             velcmds = velcmds(1:pathIdx(1),:);
%                             tstamps = tstamps(1:pathIdx(1),:);
%                             curpath = curpath(1:pathIdx(1),:);
%                         end
%                     end
%                 else
%                     if info.ExitFlag == 2
